...
$$T = {{\overline X - \mu} \over {\sigma / \sqrt n}} = {{\overline X - \mu} \over 2,5} \sim \mathcal N (0,1)$$

$$ P \left ( \left \lvert {{ \overline X - \mu} \over {\sigma / \sqrt n}} \right \rvert \leqslant u_{0,975} \right ) = 0,95 $$

L'intervalle de confiance est défini par  $\left \lvert {{ \overline X - \mu} \over {\sigma / \sqrt n}} \right \rvert \leqslant u_{0,975}$.

$$ -u_{0,975} \leqslant {{\overline X - \mu} \over {\sigma / \sqrt n}} \leqslant u_{0,975} $$
$$ - u_{0,975} \leqslant {{\mu - \overline X } \over {\sigma / \sqrt n}} \leqslant u_{0,975} $$ (centré en 0)
$$ - u_{0,975} {\sigma  \over \sqrt n} \leqslant \mu - \overline X \leqslant u_{0,975} {\sigma  \over \sqrt n} $$
$$ \overline X - u_{0,975} {\sigma  \over \sqrt n} \leqslant \mu  \leqslant \overline X + u_{0,975} {\sigma  \over \sqrt n} $$
$$ IC_{0,95} = \left [  \overline X + u_{0,975} {\sigma  \over \sqrt n} ;  \overline X - u_{0,975} {\sigma  \over \sqrt n} \right ] $$

Réalisation : $\left [ \overline x - u_{0,975} \times {\sigma \over \sqrt n} ; \overline x + u_{0,975} \times {\sigma \over \sqrt n} \right ]$

A.N. : $\overline x = {{78 + 58 + 91 + 76} \over 4}$, $\sigma = 5$, $\sqrt n = \sqrt 4$, $u_{0,975} = 1,96$
$\overline x = 82,5$ : estimation ponctuelle de $\mu$.

$$IC_{0,95} = \left [ 82,5 - 1,96 \times {5 \over 2} ; 82,5 + 1,95 \times {5 \over 2 } \right ] = [77,6 \ ; 87,4]$$

Estimation ponctuelle de $\sigma ^2$ ; $\sigma$ : $$ S^2 = {{\sum_{i = 1} ^n (X_1 - \overline X)^2} \over {n - 1}} = {n \over {n - 1}} {{\sum (X_i - \overline X )^2} \over n} = {{\sum (X_i - \overline X )^2} \over {n - 1}}$$
$$S^2 = {{(78 - 82,5)^2 + (85 - 82,5)^2 + (91 - 82,5)^2 + (76 - 82,5)^2} \over 3} = 47 $$ $$S = \sqrt 47 \approx 6,86$$

$$ {{ \overline X - \mu} \over {S / \sqrt n}} \sim \mathcal T_{n - 1} $$

$$ P\left ( \left \lvert {{ \overline X - \mu} \over {S / \sqrt n}} \right \rvert  \leqslant t_{n -1; 1 - \alpha / 2} \right ) = 0,95 $$

$$ \overline X - t_{n -1; 1 - \alpha / 2} {S \over \sqrt n} \leqslant \mu \leqslant \overline X + t_{n -1; 1 - \alpha / 2}  \times {S \over \sqrt n}$$

$$IC_{0,95} = \left [ \overline X - t_{3; 0,975} {S \over \sqrt n} ; \overline X + t_{3;0,975} {S \over \sqrt n} \right ] $$

Réalisation : $\left [ \overline x - t_{3;0,975} {S \over \sqrt n} ; \overline x + t_{3;0,975} {S \over \sqrt n} \right ]$, $\overline x = 82,5$,  $t_{3;0,975} = 3,182$, $s = \sqrt 47 \approx 6,86$, $n = 4$.

$$IC'_{0,95}  = \left [ 82,5 - 3,182 \times {6,82 \over 2} ; 82,5 + 3,182 \times {6,82 \over 2} \right ] = [71,6 ; 93,4] \text{ non inclus } [75,95]$$
