...
$$\overline x = {{78 + 58 + 91 + 76} \over 4} = 82,5  \text{ (estimation ponctuelle de } \mu \text{)}$$
...
\text{(estimation ponctuelle de } \sigma^2 \text{)} $$ $$S = \sqrt 47 \approx 6,86 \text{ (estimation ponctuelle de } \sigma \text{)}$$
