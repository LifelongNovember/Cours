...
$$ F_2 : \vec{n_2} = \vec{AC} \land \vec{AD} = \overset{\vec{ AC}}{\begin{pmatrix} -1 \\ 0 \\ -2 \end{pmatrix}}  \land \overset{\vec{AD}}{\begin{pmatrix} 0 \\ 2 \\ -2 \end{pmatrix}} = \begin{pmatrix} 0 \cdot (-1) - (-2) \cdot 2 \\ -(-1) \cdot (-1) - (-2) \cdot 0)) \\ -1 \cdot{ 0) \cdot (1) (2) \end{pmatrix} $$
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MzI1NTk0NTEsMTMwMjY2MDM4MCwtMT
